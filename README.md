...
4. **生活空間** = 住居の点（最新写真で屋根を 1 棟ずつ確認した 41 点。周囲「住居の半径」既定 20 m）∪ 住宅地の多角形（任意）∪ 田畑 ∪ 人工物。任意で「人工物の周囲 N m」も加えられます。住居の点は画面上でクリックして追加・削除できます。
...
- **森林緩衝帯の定義**: 田畑や住宅地は人間の生活空間であり緩衝帯ではない。緩衝帯は、生活空間の外側で密な森林との間にある間伐地・疎林・草地の帯（既定で生活空間から 50 m 以内）。住宅は屋根の位置を点で指定（既定 41 棟、半径 20 m）、田畑・人工物は分類結果から自動判定。
...
| 3 | 2010 | カラー、夏季の緑、中程度の解像度（2007 年以降相当） |
| 4 | 2020 | 高解像度のオルソ画像（最新写真相当） |

画像番号 3 と 5 の順序は、耕作地の分布から 5 → 3 の順と判断しました。実際の撮影年が分かれば「観測時期」パネルで修正してください（傾向線と消失予測年はそれに応じて変わります）。
