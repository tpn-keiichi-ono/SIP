...
`data/photos/mauracho/` の現地写真 86 枚（2026-09-23 撮影、EXIF に GPS・撮影方向あり）を、俯瞰写真の上に番号付きのピンで表示します。
ピンの棒は撮影方向、白い線は撮影の順路です。ピンをクリックすると写真・撮影時刻・標高・方向・座標と、**その地点の現在の年の判定**（緩衝帯／田畑／森林など）を表示し、「前／次」で順に確認できます。「表示」パネルの「現地写真のピン」で切り替えます。
